            ...
            <div class="col col--xs-24 col--md-12">
                <div class="two-link-ad">
                    ...
                    <div class="two-link-ad__links-container">
                        <a class="two-link-ad__link" href="#">
                            <i class="two-link-ad__icon icon-indoor-lighting"></i>
                            INDOOR LIGHTING LAYOUT TOOL >
                        </a>
                        <a class="two-link-ad__link" href="#">
                            <i class="two-link-ad__icon icon-outdoor-lighting"></i>
                    ...
                    <a class="cta-ad__link" href="#">
                        <div class="cta-ad__content-container">
                            <h3 class="highlighted-text__title-container--two-lines">
                                <span class="cta-ad__highlighted-title highlighted-text highlighted-text--orange">INSTALL LIKE</span>
                                <br />
                                <span class="cta-ad__highlighted-title--bottom cta-ad__highlighted-title highlighted-text highlighted-text--orange">A BOSS.</span>
                            </h3>
                            <div class="cta-ad__copy-container">
                                <p class="cta-ad__copy">Find step-by-step videos, visual aids and more here.</p>
                                <button class="button button--white" href="#">LEARN MORE</button>
                            </div>
                        </div>
                    </a>
                </div>
